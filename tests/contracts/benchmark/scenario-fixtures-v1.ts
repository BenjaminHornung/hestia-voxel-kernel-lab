...
export const BENCHMARK_TEST_SCENARIO_DEFINITIONS_V1 = [
  ...
  ], [capability('performance-time-origin', 'must-support'), capability('webgl2', 'must-declare'), capability('webgpu', 'must-declare')], ['candidate', 'mesher']),
  ...
  ], [capability('performance-time-origin', 'must-support'), capability('webgl2', 'must-declare'), capability('webgpu', 'must-declare')], ['candidate', 'chunk-edge', 'mesher']),
  ...
  ], [capability('dedicated-worker', 'must-support'), capability('long-tasks', 'must-declare'), capability('performance-time-origin', 'must-support'), capability('webgl2', 'must-declare'), capability('webgpu', 'must-declare')], ['candidate', 'worker-count']),
